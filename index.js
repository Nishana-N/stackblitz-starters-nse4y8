...
app.get("/hotels/filter/amenity",(req,res) =>{
  ...
  let filteredAmenity = filterByAmenity(amenity)
  res.json({ hotels: filteredAmenity })
});
...
app.get("/hotels/filter/country",(req,res) => {
  ...
  let filteredCountry = filterByCountry(country)
  res.json({ hotels : filteredCountry})
});
...
app.get("/hotels/filter/category",(req,res) => {
  ...
  let filteredCategory = filterByCategory(category);
  res.json({ hotels : filteredCategory})
});
